...
def main(j, args, params, tags, tasklet):
    ...
    result = acc.executeJumpscript('jumpscale', 'templates_list', nid=j.application.whoAmI.nid,
    ...
    for template in templates.values():
        ...
        out.append("|%(domain)s|[%(name)s|ays/template?domain=%(domain)s&name=%(name)s]|%(metapath)s|%(instances)s|" % template)
