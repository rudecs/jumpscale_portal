...
class system_gridmanager(j.code.classGetBase()):
    ...
    def __init__(self):
        ...
        self.osis_node = j.core.osis.getCategory(osis,"system","node")
        self.osis_job = j.core.osis.getCategory(osis,"system","job")
        self.osis_eco = j.core.osis.getCategory(osis,"system","eco")
        self.osis_process = j.core.osis.getCategory(osis,"system","process")
        self.osis_application = j.core.osis.getCategory(osis,"system","applicationtype")
        self.osis_grid = j.core.osis.getCategory(osis,"system","grid")
        self.osis_machine = j.core.osis.getCategory(osis,"system","machine")
        self.osis_disk = j.core.osis.getCategory(osis,"system","disk")
        self.osis_vdisk = j.core.osis.getCategory(osis,"system","vdisk")
        self.osis_alert = j.core.osis.getCategory(osis,"system","alert")
        self.osis_log = j.core.osis.getCategory(osis,"system","log")
        self.osis_nic = j.core.osis.getCategory(osis,"system","nic")
        self.osis_jumpscript = j.core.osis.getCategory(osis,"system","jumpscript")
